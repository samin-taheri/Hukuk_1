...
// ----------------------------------------------------------------------
export default function Casees() {
    ...
    const changeActivity = (cId) => {
        casesService.changeActivity2(cId).then(result => {
            getAllCases()
                                                    ...
                                                    {cases.map((row) => (
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell align="left">
                                                                <Button
                                                                    onClick={() => getByIdCases(row.CaseeId)}                                                                    variant="contained"
                                                                    sx={{backgroundColor: '#b1b9be'}}
                                                            ...
                                                            <TableCell align="left">
                                                                <Button
                                                                    onClick={() => navigate('/dashboard/cases/caseUpdateHistory/' + row.CaseeId)}                                                                 variant="contained"
                                                                    sx={{backgroundColor: '#b1b9be'}}
                                                                    startIcon={<Icon icon={layersOutline}/>}
                                                                >
                                                                    History
